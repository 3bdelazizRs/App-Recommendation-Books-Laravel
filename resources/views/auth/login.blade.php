...
<body>
  ...
  @if(session('errorConfirmation'))
    ...
    @if(session('success'))
        <div style="position:absolute; z-index:999; top: 20px; right: 20px;" id="successToast" class="toast align-items-center text-bg-success border-0" role="alert" aria-live="assertive" aria-atomic="true">
          <div class="d-flex">
            <div class="toast-body">
              {{ session('success') }}
            </div>
